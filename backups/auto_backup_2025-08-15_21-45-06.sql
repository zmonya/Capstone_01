...
CREATE TABLE `files` (
  ...
  CONSTRAINT `chk_physical_storage_path` CHECK (`physical_storage_path` regexp '^[A-Z][0-9]+(/[A-Z][0-9]+){3}$')
...
INSERT INTO `files` VALUES ('111',NULL,'484c2f5a-9131-4c51-a7a2-3ce814670c20.pdf',NULL,'14','2025-08-15 13:12:45','58972','pdf',NULL,'active',NULL,NULL,NULL,NULL,'Uploads/315a1ff32ff8a218_484c2f5a-9131-4c51-a7a2-3ce814670c20.pdf');
INSERT INTO `files` VALUES ('112',NULL,'9e66dace5c74a33b2bc5a65f589ab7f4.jpg',NULL,'14',NULL,'186297','',NULL,'active',NULL,NULL,NULL,NULL,'uploads/a87f4efaf1279281_9e66dace5c74a33b2bc5a65f589ab7f4.jpg');
INSERT INTO `files` VALUES ('113',NULL,'2808dbca-55f2-4fc0-a374-e906256a8e11.jpg',NULL,'1','2025-08-15 20:06:26','798819','',NULL,'active',NULL,NULL,NULL,NULL,'Uploads/a191b9d5854df15a_2808dbca-55f2-4fc0-a374-e906256a8e11.jpg');
INSERT INTO `files` VALUES ('114',NULL,'329124980_738749514244917_2361928253639741572_n.jpg',NULL,'1','2025-08-15 20:37:20','96557','',NULL,'active',NULL,NULL,NULL,NULL,'Uploads/a8d3df544d143a30_329124980_738749514244917_2361928253639741572_n.jpg');
...
INSERT INTO `text_repository` VALUES ('106','111',NULL);
...
CREATE TABLE `transaction` (
  ...
  CONSTRAINT `transaction_ibfk_1` FOREIGN KEY (`File_id`) REFERENCES `files` (`file_id`),
  CONSTRAINT `transaction_ibfk_2` FOREIGN KEY (`User_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `transaction_ibfk_3` FOREIGN KEY (`Users_Department_id`) REFERENCES `users_department` (`users_department_id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Data for transaction
INSERT INTO `transaction` VALUES ('13','28','23','12','2','pending','2025-08-15 19:42:49','File sent for review');
INSERT INTO `transaction` VALUES ('19','27','1','3','2','pending','2025-08-15 19:51:32','File sent for review');
INSERT INTO `transaction` VALUES ('20','29','1','3','2','pending','2025-08-15 19:51:39','File sent for review');
INSERT INTO `transaction` VALUES ('21','29','23','12','2','pending','2025-08-15 19:51:40','File sent for review');
INSERT INTO `transaction` VALUES ('28','113','14','5','2','pending','2025-08-15 20:06:51','File sent for review');
INSERT INTO `transaction` VALUES ('31','113','14','5','2','pending','2025-08-15 20:26:22','File sent for review');
INSERT INTO `transaction` VALUES ('32','113','14','5','2','pending','2025-08-15 20:26:52','File sent for review');
INSERT INTO `transaction` VALUES ('33','113','14','5','2','pending','2025-08-15 20:27:10','File sent for review');
...
INSERT INTO `transactions` VALUES ('140','14',NULL,NULL,'login_success','','2025-08-15 13:09:30','User logged in successfully');
INSERT INTO `transactions` VALUES ('141','14',NULL,'111','file_upload','','2025-08-15 13:12:45','Uploaded 484c2f5a-9131-4c51-a7a2-3ce814670c20.pdf');
INSERT INTO `transactions` VALUES ('142','14',NULL,NULL,'login_success','','2025-08-15 19:23:57','User logged in successfully');
INSERT INTO `transactions` VALUES ('143','14',NULL,'28','other','','2025-08-15 19:42:49','file_sent');
INSERT INTO `transactions` VALUES ('144','14',NULL,'27','other','','2025-08-15 19:51:32','file_sent');
INSERT INTO `transactions` VALUES ('145','14',NULL,'29','other','','2025-08-15 19:51:40','file_sent');
INSERT INTO `transactions` VALUES ('146','1',NULL,'113','file_upload','','2025-08-15 20:06:26','Uploaded 2808dbca-55f2-4fc0-a374-e906256a8e11.jpg');
INSERT INTO `transactions` VALUES ('147','1',NULL,'113','other','','2025-08-15 20:06:51','file_sent');
INSERT INTO `transactions` VALUES ('148','1',NULL,'113','other','','2025-08-15 20:26:22','file_sent');
INSERT INTO `transactions` VALUES ('149','1',NULL,'113','other','','2025-08-15 20:26:52','file_sent');
INSERT INTO `transactions` VALUES ('150','1',NULL,'113','other','','2025-08-15 20:27:10','file_sent');
INSERT INTO `transactions` VALUES ('151','14','5','113','file_sent','','2025-08-15 20:35:50','pending');
INSERT INTO `transactions` VALUES ('152','1',NULL,'113','other','','2025-08-15 20:35:50','file_sent');
INSERT INTO `transactions` VALUES ('153','14','5','113','file_sent','','2025-08-15 20:36:26','pending');
INSERT INTO `transactions` VALUES ('154','1',NULL,'113','other','','2025-08-15 20:36:26','file_sent');
INSERT INTO `transactions` VALUES ('155','14',NULL,NULL,'login_success','','2025-08-15 20:36:54','User logged in successfully');
INSERT INTO `transactions` VALUES ('156','1',NULL,'114','file_upload','','2025-08-15 20:37:20','Uploaded 329124980_738749514244917_2361928253639741572_n.jpg');
INSERT INTO `transactions` VALUES ('157','14','5','114','file_sent','','2025-08-15 20:38:09','pending');
INSERT INTO `transactions` VALUES ('158','1',NULL,'114','other','','2025-08-15 20:38:09','file_sent');
INSERT INTO `transactions` VALUES ('159','14',NULL,NULL,'login_success','','2025-08-15 21:12:18','User logged in successfully');
...
-- Data for users
INSERT INTO `users` VALUES ('1','AdminUser','$2y$10$eJZRt81QMaXGFuYmSF9OSOYvC2x10PtgDJLFgro0KnYvbFnBrGV7y','admin@example.com','admin',NULL,'0','2025-07-04 10:48:00');
...
INSERT INTO `users` VALUES ('12','lea','$2y$10$JvUys5dxVSCmFsSU8Zw1Uu6WPrB2vXtx4OxkpK.Iv.5h9.kQzq17W','nlea@example.com','admin',NULL,'1','2025-07-04 10:59:00');
...
INSERT INTO `users` VALUES ('15','user','$2y$10$OVU0nH8jZ7SIec6iNs8Ate8vuxx7xUSM10YePtoUZxhd0FIz3eRXW','user@example.com','client',NULL,'1','2025-07-16 07:03:20');
